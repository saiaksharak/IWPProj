	...
	<div class="header fix">
		...
		<div class="nav fix">
			<ul>
				...
				<li  class="active"><a href="e_get_in_touch.php">Contact Us</a></li>
			</ul>
		</div>
		...
		<div class="icon1">
			...
			<label>Location <span class="details"><br>VIT,Vellore<br>Tamil Nadu</span></label>
		</div>
		<div class="icon2">
			<div class="box">
				<i class="fa fa-phone fa-3x" aria-hidden="true"></i>
			</div>	
			<label>Call Us (24*7) <span class="details"><br>(+91) 7387214676<br>(+91) 7387214676</span></label>
		</div>
		<div class="icon3">
			<span class="box">
			<i class="fa  fa-envelope-o fa-2x" aria-hidden="true"> </i>
			</span>
			<label>MAIL US<span class="details"><br>JayakumarSirsFavouriteStudents@gmail.com</span></label>
		</div>
		<div class="contactbox">
		<h3> Get In Touch </h3>
		<form id="myform" action="get_in_touch.php" method="post">
