		...
		<div class="footer">
			...
			<div class="scircle scircle2">
				<a href="https://www.geeksforgeeks.org/" target="blank"><i class="fa fa-twitter fa-lg" aria-hidden="true" ></i></a>
			</div>
			<div class="scircle scircle3">
				<a href="https://www.geeksforgeeks.org/" target="_blank"><i class="fa fa-instagram fa-lg" aria-hidden="true" ></i></a>
			</div>
			<div class="scircle scircle4">
				<a href="https://www.geeksforgeeks.org/" target="_blank"><i class="fa fa-linkedin fa-lg" aria-hidden="true" ></i></a>
			</div>
		</div>